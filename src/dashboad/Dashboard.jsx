    ...
    <div className={cn("w-full", className)}>
      ...
      <div className="flex gap-2">
        ...
        <div className=" w-[60%] space-y-2">
          {/* row 1 */}
          <ul className="grid grid-cols-3 space-x-3">
            {Row1.map((item, index) => (
          ...
          <div className="">
            ...
            <ul className="space-y-2 overflow-scroll h-[170px]">
        ...
        <div className=" w-[40%] flex flex-col items-center justify-around">
          <div className="bg-[#161E54] w-[427px] flex flex-col justify-between pb-6 h-[225px] px-6 text-white rounded-md ">
          ...
          <div className="w-[427px] h-[300px] p-4 border border-zinc-400 rounded-md overflow-scroll">
            <h2>
              <div className="flex justify-between">
                <p className="font-semibold tracking-wide">Upcoming Schedule</p>
                <input
                  type="date"
...
function List({ icon1, icon2 = "", content, time }) {
  return (
    <div className="bg-zinc-200 rounded-md border flex justify-between px-4 py-1.5">
      <div className="">
        <p>{content}</p>
